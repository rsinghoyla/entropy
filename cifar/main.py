...
trainset = datasets.CIFAR10(
    root='./data', train=True, download=False, transform=transform_train,proportion = args.prop, sort_order = args.sort_order)
trainloader = torch.utils.data.DataLoader(
    trainset, batch_size=128, shuffle=True, num_workers=1)
print('datasets size',trainset.__len__())

save_dir = args.save_dir+'_'+str(trainset.__len__())+'_'+str(trainset.stats)

testset = torchvision.datasets.CIFAR10(
    root='./data_test', train=False, download=True, transform=transform_test)
