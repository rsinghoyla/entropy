...
trainset = datasets.Flowers102(
    root='./data', split='test', download=False, transform=transform_train, sort_on = args.sort_on, sort_order = args.sort_order, proportion = args.prop)
trainloader = torch.utils.data.DataLoader(
    trainset, batch_size=128, shuffle=True, num_workers=1)

#save_dir = args.save_dir+'_'+str(trainset.__len__())
